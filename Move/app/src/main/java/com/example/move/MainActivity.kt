    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun moveObject(direction : String){
            ...
            when(direction){
                ...
                //"up"    ->findViewById<ImageView>(R.id.box).setTint(Color.MAGENTA);
                ...
                "right" ->findViewById<ConstraintLayout>(R.id.main).setBackgroundColor(Color.YELLOW);
            }
            ...
            if(box.getX()==640F && box.getY()==968F){
